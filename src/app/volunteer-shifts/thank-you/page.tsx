...
export default function VolunteerShiftThankYouPage() {
  return (
      ...
      <div className="mx-auto max-w-2xl">
        <div className="rounded-2xl border border-[#2A0E10] bg-[#0B0B0B] p-8 shadow-2xl">
          ...
          <p className="mt-4 text-lg text-[#B7B7B7]">
            Your volunteer shift signup has been received.
          </p>

          <p className="mt-3 text-[#B7B7B7]">
            An Encuerado admin will review the shift assignments and follow up if
            needed.
          </p>
