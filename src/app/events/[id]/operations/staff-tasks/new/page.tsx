...
export default async function NewStaffTaskPage({
  ...
  const createTask = createStaffTask.bind(null, event.id, `/events/${event.id}/operations`)
    ...
    <main className="min-h-screen bg-black p-8 text-white">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="rounded-2xl border border-[#2A0E10] bg-[#0B0B0B] p-8">
          <h1 className="text-3xl font-bold text-white">Add Staff Task</h1>
          <p className="mt-2 text-[#B7B7B7]">Create a new staff task.</p>

          <form action={createTask} className="mt-8 grid gap-5">
            ...
            <label className="grid gap-2">
              ...
              <input name="assignedTo" className={inputClass} />
            </label>
            <label className="grid gap-2">
